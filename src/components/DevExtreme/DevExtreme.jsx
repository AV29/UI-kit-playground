...
import DataGrid, { Column, Editing, ColumnChooser, ColumnFixing, RequiredRule, EmailRule } from 'devextreme-react/data-grid';
import styles from './DevExtreme.scss';
...
const DevExtreme = () => {
  ...
  return (
    <DemoThemeContainer title="DevExtreme">
      ...
      <DemoControlsContainer title="Grid" className={styles.gridContainer}>
        <DataGrid
          id={'gridContainer'}
